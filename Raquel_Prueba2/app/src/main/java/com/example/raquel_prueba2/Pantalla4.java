...
public class Pantalla4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AutoCompleteTextView autoCompleteTextView = findViewById(R.id.miTexto);

        String[] versionesAndroid = new String[] {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this,
                android.R.layout.simple_dropdown_item_1line, versionesAndroid);
